...
ROS node for the Raspberry Pi Camera Module. Works with both the V1.x and V2.x versions of the module. v2.x cameras have better auto gain and image quality, and are thus the recommended cameras.
